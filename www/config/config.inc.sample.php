...
$config = array(
    ...
    /* Подключение к БД */
    'username' => 'name', // Имя пользователя БД
    'password' => 'psw', // Пароль пользователя БД
    'dsn' => 'mysql:host=localhost:3306;dbname=dbname', // Строка подключения для PDO

    /* Параметры миграций */
    'import_data' => 1,  // Нужно ли создавать миграции для данных
    'table_prefix' => '', // Префикс для таблиц
